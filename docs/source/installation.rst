...
which will install the latest stable release. 
...
I would highly recommend that you use Miniconda and create an environment for your machine
...
.. important::
    ...
    NumPy 2.x was not compatible with NumPy 1.x. OpenCV did not support NumPy 2.x until 4.10.0.84.
