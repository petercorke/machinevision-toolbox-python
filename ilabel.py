...
def ilabel(im, connectivity=4, minsize=0):
    ...
    lmap = np.zeros((20_000,), dtype="int32")
    ...
    #     n = 10_000
    #     print(cmd, end=": ")
    #     print(timeit.timeit(cmd, number=n, globals=locals()) / n * 1e6, " us")

    # xxtimeit("2+3")
    # xxtimeit("im[row,col]")
    # xxtimeit("lmap[curpix] = 10")
    # xxtimeit("lmap[curpix]")
